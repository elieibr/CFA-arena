...
export const fraQuestions: Question[] = [
  ...
  },
  {
    ...
    option_c: '1.50',
    correct_answer: 'A',
    explanation: 'Quick ratio = (Current assets - Inventory - Prepaid expenses) / Current liabilities = ($2,400,000 - $850,000 - $120,000) / $1,600,000 = $1,430,000 / $1,600,000 = 0.894 ≈ 0.91. The quick ratio excludes less liquid current assets to measure short-term liquidity.',
    difficulty: 1
  },
  {
    id: 'fra-016',
  ...
  },
  {
    ...
    option_c: '51.2 days',
    correct_answer: 'A',
    explanation: 'Days sales outstanding (average collection period) = 365 / Receivables turnover = 365 / 8.5 = 42.94 ≈ 42.9 days. This represents the average time it takes to collect receivables. A lower number indicates faster collection.',
    difficulty: 1
  },
  {
    id: 'fra-019',
    ...
    option_c: '$1.94',
    correct_answer: 'A',
    explanation: 'Basic EPS = (Net income - Preferred dividends) / Weighted average common shares = ($1,450,000 - $180,000) / 850,000 = $1,270,000 / 850,000 = $1.494 ≈ $1.49. Preferred dividends are subtracted because EPS measures earnings available to common shareholders.',
    difficulty: 1
  },
  {
    id: 'fra-020',
